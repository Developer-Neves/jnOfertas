...
$(window).scroll(function(){
	...
	var conteudo = $(document).height() - $(window).height();
	 ...
	 //consultando o tamanho da página no log do navegador
	/*console.log('scrollTop: ', scrollTop, ' | ', 'conteudo', conteudo);*/
	
	// mostrando no console do navegador o tamanho da pagina e do scroll
...
function loadByScrollBar(pageNumber){
	var site = $("#autocomplete-input").val(); // verificando os dados do campo de input
	$.ajax({
		method: "GET",
		url: "/promocao/list/ajax",
		data: { page: pageNumber, site: site},
		beforeSend: function(){
			$("#loader-img").show();
		},
...
function init(){
	...
	QWRAlertaPromocoes.init();
}

function error(excpetion){
	consele.log("dwr error: ", excpetion);
}
...
//acessar a nova compra atraves da notificação
